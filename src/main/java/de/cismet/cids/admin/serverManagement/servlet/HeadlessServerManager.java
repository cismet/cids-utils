...
public class HeadlessServerManager extends HttpServlet {
    ...
    private static final long serialVersionUID = 8119889634074144029L;
     ...
     * @param  out       DOCUMENT ME!
     */
    protected void printServerManager(final HttpServletRequest request,
    ...
    protected boolean validateLogin(final HttpServletRequest request) {
        boolean ret = false;
