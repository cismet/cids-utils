 ...
 * @version
 */
public class HeadlessServerManager extends HttpServlet{
    ...
    protected void refreshLogMessages() {
    ...
    protected void printServerManager(HttpServletRequest request, HttpServletResponse response, PrintWriter out) {
