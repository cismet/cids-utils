...
public class ServerManager extends HttpServlet {
     ...
     * "<!--\n" +                 "Check = confirm(\"Der Serverprozess l&auml;uft noch! Wenn Sie das Servermanagement
     * jetzt beenden, wird der Server evtl. nicht ordnungsgem&auml;&szlig; heruntergefahren.\\nDiese Managementkonsole
     * wird auch beendet werden!\\nWollen Sie das Servermanagement trotzdem beenden?\");\n" +                 "if (Check
     * == true) {\n" +                     "window.open(\"http://" + serverIP + ":" + httpPort +
     * "/cidsservermanager?server=kill-now\", \"_self\");\n" +                 "};\n" +                 "//-->\n" +
     *            "</script>\n"); } if (!serverCon.isServerRunning()) {     out.println("<script
     * type=\"text/javascript\">\n" +                 "<!--\n" +                 "Check = confirm(\"\\nWenn Sie das
     * Servermanagement beenden, wird auch diese Managementkonsole beendet werden!\\nWollen Sie das Servermanagement
     * wirklich beenden?\");\n" +                 "if (Check == true) {\n" +                     "window.open(\"http://"
     * + serverIP + ":" + httpPort + "cidsservermanager?server=kill-now\", \"_self\");\n" +                 "};\n" +
     *             "//-->\n" +                 "</script>\n"); }}*/
