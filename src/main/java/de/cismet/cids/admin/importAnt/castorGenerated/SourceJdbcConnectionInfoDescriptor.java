 ...
 * Schema.
 * $Id: SourceJdbcConnectionInfoDescriptor.java,v 1.1.1.1 2009-08-20 12:23:31 spuhl Exp $
 */
...
public class SourceJdbcConnectionInfoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SourceJdbcConnectionInfoDescriptor() {
        ...
        //-- _propList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.cismet.cids.admin.importAnt.castorGenerated.Prop.class, "_propList", "Prop", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SourceJdbcConnectionInfo target = (SourceJdbcConnectionInfo) object;
                    target.addProp( (de.cismet.cids.admin.importAnt.castorGenerated.Prop) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new de.cismet.cids.admin.importAnt.castorGenerated.Prop();
            }
        } );
        desc.setHandler(handler);
    ...
    {
        return de.cismet.cids.admin.importAnt.castorGenerated.SourceJdbcConnectionInfo.class;
