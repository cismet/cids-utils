...
public class GroupDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GroupDescriptor() {
        ...
        //-- _analyzerList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.cismet.cids.admin.analyze.castorGenerated.Analyzer.class, "_analyzerList", "analyzer", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
