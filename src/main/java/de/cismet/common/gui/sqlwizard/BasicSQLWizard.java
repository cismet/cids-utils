...
public class BasicSQLWizard extends javax.swing.JPanel {
    ...
    protected final MetaDataTreeTable databaseMetaDataTreeTable;
    protected final MetaDataTreeTable resultSetMetaDataTreeTable;
    ...
    public BasicSQLWizard() {
        ...
        this.databaseMetaDataTreeTable = new MetaDataTreeTable(new MetaDataTreeTable.DatabaseMetaDataTreeTableModel(),
                0);
        this.resultSetMetaDataTreeTable = new MetaDataTreeTable(new MetaDataTreeTable.ResultSetMetaDataTreeTableModel(),
                historySize);
    ...
    protected void initToolBars() {
        ...
        final JButton button = new JButton(this.getIcon("execute.gif"));
         ...
         * button.setToolTipText("Clear Log Window"); button.setActionCommand("clear");
         * this.setComponentHeight(this.historySelectionBox, button);this.actionToolBar.add(button);*/
    }
     ...
     */
    protected void setComponentHeight(final JComponent a, final JComponent b) {
        final Dimension dimension = b.getPreferredSize();
     ...
     */
    protected Icon getIcon(final String name) {
    ...
    /**
     * Executes the sql statement, fills the ResultSet and the ResultSetMetaData tables.
     *
    ...
    protected ResultSet execute() throws SQLException {
        final ResultSet resultSet = this.sqlEditor.execute(this.historySelectionBox.getSelectedIndex());
     ...
     *
     * @param  sqlexp  SQLException the SQLException
     */
    protected void handleSQLException(final SQLException sqlexp) {
     ...
     * { this.resultSetMetaDataTreeTable.reset(); this.resultSetMetaDataTreeTable.getHistory().setHistoryEntry(null,
     * index);
     *
     * this.resultSetTable.reset(); this.resultSetTable.getHistory().setHistoryEntry(null, index);}*/
     ...
     *
     * <p>Performs initialization of tables.</p>
     *
     * @param  connection  New value of property connection.
     * @param  url         DOCUMENT ME!
     */
    public void setConnection(final java.sql.Connection connection, final String url) {
        try {
    ...
    {
        final javax.swing.JPanel dbMetaPanel;
        final javax.swing.JPanel mainQueryPanel;
        final javax.swing.JPanel mainResultPanel;
        final javax.swing.JSplitPane mainSplitPane;
        final javax.swing.JPanel messagePanel;
        final javax.swing.JSplitPane querySplitPane;
        final javax.swing.JPanel resultMetaPanel;
        final javax.swing.JPanel resultPanel;
        final javax.swing.JSplitPane resultSplitPane;
        final javax.swing.JPanel sqlEditorPanel;
        ...
        dbMetaPanel.setBorder(new javax.swing.border.CompoundBorder(
                new javax.swing.border.CompoundBorder(
                    new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 5, 5, 5)),
                    new javax.swing.border.TitledBorder("Database Meta Data")),
                new javax.swing.border.EmptyBorder(new java.awt.Insets(3, 5, 5, 5))));
        ...
        sqlEditorPanel.setBorder(new javax.swing.border.CompoundBorder(
                new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 5, 5, 5)),
                new javax.swing.border.CompoundBorder(
                    new javax.swing.border.TitledBorder("SQL Editor"),
                    new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 5, 5, 5)))));
        ...
        resultMetaPanel.setBorder(new javax.swing.border.CompoundBorder(
                new javax.swing.border.CompoundBorder(
                    new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 5, 5, 5)),
                    new javax.swing.border.TitledBorder("ResultSet Meta Data")),
                new javax.swing.border.EmptyBorder(new java.awt.Insets(3, 5, 5, 5))));
        ...
        resultPanel.setBorder(new javax.swing.border.CompoundBorder(
                new javax.swing.border.CompoundBorder(
                    new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 5, 5, 5)),
                    new javax.swing.border.TitledBorder("ResultSet")),
                new javax.swing.border.EmptyBorder(new java.awt.Insets(3, 5, 5, 5))));
        ...
        statusLabel.setBorder(new javax.swing.border.CompoundBorder(
                ...
                new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 3, 1, 2))));
        ...
        SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // JTree jt = new JTree(new
                        // DefaultTreeModel((TreeNode)sw.databaseMetaDataTreeTable.getTreeTableModel().getRoot()));
                        // jf.getContentPane().add(new JScrollPane(jt), BorderLayout.CENTER); jf.repaint();
                    } catch (Exception exp) {
